...
<div class="col-md-12">
	...
	<div style="width:100%; height:700px, padding-top:50px; padding-bottom:100px;" class="zam">
		<button onclick="window.print();" class="only_sc btn btn-info float-right zam btn-link">Production Print</button>  
	<div>
